...
{
  std::string line;
  std::ifstream input("C:/Users/Dwight/Desktop/c_dev/AoC/19/part1/build/input.txt");
  ...
  for (const auto &pattern : patterns){
    if (possible_design(pattern, towels, memo)) {
      number_of_designs_possible += 1;
    }
  }
